...
// ─── Variant: Split ───────────────────────────────────────────────────────────
const HeroSplit: React.FC<HeroProps> = ({ title, subtitle, primaryCta, secondaryCta, badgeText, accentColor, bgColor, textColor }) => {
  return (
    <section
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col">
            {badgeText && (
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4 }}
                className="mb-4 sm:mb-6 self-start inline-flex items-center gap-x-2 rounded-full px-3 py-1 sm:px-4 sm:py-1.5 text-[11px] sm:text-xs font-semibold border border-white/20"
          ...
          {/* Right: Decorative stats / visual block */}
...
// ─── Variant: Minimal ─────────────────────────────────────────────────────────
const HeroMinimal: React.FC<HeroProps> = ({ title, subtitle, primaryCta, secondaryCta, bgColor, textColor, accentColor }) => {
  return (
    <section
      ...
      <div className="mx-auto max-w-4xl">
        ...
        {subtitle && (
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
            className={cn("mt-8 text-base sm:text-xl leading-relaxed max-w-2xl border-l-4 pl-6", !textColor && "text-zinc-500 dark:text-zinc-400 border-zinc-200 dark:border-zinc-800")}
...
// ─── Variant: Bold ────────────────────────────────────────────────────────────
const HeroBold: React.FC<HeroProps> = ({ title, subtitle, primaryCta, badgeText, accentColor, bgColor, textColor }) => {
  return (
    <section
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl text-center">
        ...
        {subtitle && (
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
            className="mx-auto mt-8 max-w-2xl text-base sm:text-lg leading-relaxed"
